...
void mpopt_qap_solver_set_stopping_criterion(mpopt_qap_solver* s, double epsilon_lb, double epsilon_ub, int k_batches) { s->solver.set_stopping_criterion(epsilon_lb, epsilon_ub, k_batches); }
